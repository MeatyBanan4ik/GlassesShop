                    ...
                    <div class="col-md-12">
                        <div class="bread">
                            <ul itemscope="itemscope" itemtype="http://schema.org/BreadcrumbList" class="breadcrumbs testtt">
                                ...
                                <li itemprop="itemListElement" itemscope="itemscope" itemtype="http://schema.org/ListItem">
                                    <a href="/sunglasses/" title="Оправа для очков" itemprop="item">
                                        <span itemprop="name">Оправа для очков</span>
                                    </a>
                                    <meta itemprop="position" content="1">
                                </li>
                                <li itemprop="itemListElement" itemscope="itemscope" itemtype="http://schema.org/ListItem">
                                    <span itemprop="name">Оправа для очков {{ $product->name }}</span>
                                    <meta itemprop="position" content="2">
                                </li>
                            </ul>
                        </div>
                        <div class="go-back-mobile">
                            <a href="/sunglasses/">Оправа для очков</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container tabl-full">
                    ...
                    <div class="product-top">
                        ...
                        <div class="row"><div class="col-12">
                                <h1>Оправа для очков {{ $product->name }}</h1>
                            </div>
                            <div class="col-12">
